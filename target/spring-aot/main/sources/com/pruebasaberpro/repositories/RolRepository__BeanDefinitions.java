...
/**
 * Bean definitions for {@link RolRepository}.
 */
@Generated
public class RolRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'rolRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getRolRepositoryInstanceSupplier() {
    return BeanInstanceSupplier.<JpaRepositoryFactoryBean>forConstructor(Class.class)
            .withGenerator((registeredBean, args) -> new JpaRepositoryFactoryBean(args.get(0)));
  }

  /**
   * Get the bean definition for 'rolRepository'.
   */
  public static BeanDefinition getRolRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.pruebasaberpro.repositories.RolRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.RolRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.pruebasaberpro.repositories.RolRepositoryImpl__AotRepository(entityManager, context));
      }
    });
