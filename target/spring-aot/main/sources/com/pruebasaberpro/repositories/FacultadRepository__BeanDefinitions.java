...
/**
 * Bean definitions for {@link FacultadRepository}.
 */
@Generated
public class FacultadRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'facultadRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getFacultadRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'facultadRepository'.
   */
  public static BeanDefinition getFacultadRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, FacultadRepository.class, Facultad.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.pruebasaberpro.repositories.FacultadRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.FacultadRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.pruebasaberpro.repositories.FacultadRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getFacultadRepositoryInstanceSupplier();
