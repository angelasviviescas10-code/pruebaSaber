...
public class RepositoryComposition__BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.EstudianteRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ResultadoRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.FacultadRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.RolRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.ExamenRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.BeneficioRepository.fragments#0'.
     */
